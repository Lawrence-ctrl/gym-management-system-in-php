<?php
  ...
  $hello = $conn->query("SELECT b.*,c.*,p.* FROM booking as b LEFT JOIN current as c ON b.bookduration = c.current_id LEFT JOIN plans as p ON b.bookuserplan = p.plan_id WHERE b.book_id='$member_id'");
                ...
                <div class="row">
                  <div class="table-responsive">
                   <table class="table table-striped table-dark">
                    <tr>
                        <td colspan="2"><center><img src="images/<?php echo $hee['bookuser_img']?>" class="rounded"></center></td>                      
                      </tr>
                      <tr>
                         <td>ID:</td>
                         <td><?php echo $hee['book_id']?></td>
                      </tr>
                      <tr>
                         <td>Name:</td>
                         <td><?php echo $hee['bookuser_name']?></td>
                      </tr>
                      <tr>
                        <td>Email:</td>
                        <td><?php echo $hee['bookuser_email']?></td>
                      </tr>
                      <tr>
                        <td>Address:</td>
                        <td><?php echo $hee['bookuser_address']?></td>
                      </tr>
                      <tr>
                        <td>Age:</td>
                        <td><?php echo $hee['bookage']?></td>
                      </tr>
                      <tr>
                        <td>Weight:</td>
                        <td><?php echo $hee['bookweight']?>LB</td>
                      </tr>
                      <tr>
                        <td>Gender:</td>                     
                          <?php if($hee['bookgender']=='1'){ ?>
                                <td>Male</td>
                          <?php }else{ ?>
                                <td>Female</td>
                          <?php } ?>
                      ...
                      <tr>
                        <td>Duration:</td>
                        <td><?php echo $hee['current_name']?></td>
                      </tr>
                      <tr>
                        <td>Start Date:</td>
                        <td><?php echo $hee['bookdate']?></td>
                      </tr>
                      <tr>
                        <td>End Date:</td>
                        <td><?php echo $hee['enddate']?></td>
                      </tr>
                      <tr>
                         <td>
                            <a class="btn btn-block btn-social btn-facebook ha" href="<?php echo $hee['bookuser_fb']?>">
