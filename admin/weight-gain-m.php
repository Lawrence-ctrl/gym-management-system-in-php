<?php
  ...
  {
    if($_GET['cat_id'] == '1') {
       $exe = $conn->query("SELECT * FROM exercises WHERE gender='1' AND exer_plan='2'");
    }elseif($_GET['cat_id']) {
       $cat_id = mysqli_real_escape_string($conn,$_GET['cat_id']);
       $exe = $conn->query("SELECT * FROM exercises WHERE exer_category_id='$cat_id' and gender='1' AND exer_plan='2'"); 
    } 
  }else{
      $exe = $conn->query("SELECT * FROM exercises WHERE gender='1' AND exer_plan='2'");
  }  
          ...
          <?php include('includes/navbar.php'); ?>       
              <div class="container-fluid">         
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">                  
                     ...
                     <?php }else{ ?>
                        <h1 class="h3 mb-0 text-gray-800">Weight Gain Exercises (Male)</h1>
                     <?php } ?>             
