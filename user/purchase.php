<?php
   ...
   include('../admin/function.php');
    $che = $conn->query("SELECT booking.*,plans.*,current.* FROM booking LEFT JOIN plans ON booking.bookuserplan=plans.plan_id LEFT JOIN current ON booking.bookduration=current.current_id WHERE bookuser_email = '".$_SESSION['useremail']."' AND bookuser_id='".$_SESSION['userid']."'");
    $cher = $che->fetch_assoc();
   $x = 0;
   date_default_timezone_set('Asia/Rangoon');
   $current = strtotime(date('Y-m-d H:i:s'));
   $time = strtotime(date($cher['enddate']));
   $lol = $time - $current;
                  ...
                  <div class="table-responsive">
                   <table class="table table-striped table-info">
                      <tr>
                         ...
                         <td style="text-align: center;"><?php echo $cher['book_id']?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;"><?php echo $cher['current_name']?></td>
                      </tr>
                      <tr>
                        <td width="30%" style="text-align: center;">Start Date:</td>
                        <td style="text-align: center;"><?php echo $cher['bookdate']?></td>
                      </tr>
                      <tr>
                        <td width="30%" style="text-align: center;">End Date:</td>
                        <td style="text-align: center;"><?php echo $cher['enddate']?></td>
                      </tr>
