<?php
     ...
     if(isset($_GET['cat_id']))
  {
    if($_GET['cat_id'] == '1') {
       ...
       $exe = $conn->query("SELECT * FROM exercises WHERE exer_category_id='$cat_id' and gender='2' AND exer_plan='1'"); 
    } 
  }else{
      $exe = $conn->query("SELECT * FROM exercises WHERE gender='2'");
  }  
			...
			<div class="content">
				<div class="page-inner">
                    ...
                    <?php 
                     ...
                     <?php }else{ ?>
                        <h4 class="page-title">Exercises (Female)</h4>
                     <?php } ?>                         
                    </div> 
                    <div class="row">
